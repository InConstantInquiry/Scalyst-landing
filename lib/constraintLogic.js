...
const ACTION_DETAILS = {
  'Cash Flow': [
    {
      ...
      steps: [
        'Rewrite all client contracts with Net-15 or Net-30 terms â remove Net-60 entirely',
        ...
        'Review AR aging weekly â escalate anything over 45 days to a direct phone call'
      ],
  ...
  'Margin': [
    {
      ...
      steps: [
        'Calculate gross margin per client or engagement â rank from highest to lowest',
    ...
    },
    {
      ...
      steps: [
        ...
        'Add a pricing floor â no proposal goes out under your minimum margin threshold',
  ...
  'Capacity': [
    ...
    },
    {
      ...
      metric: 'Capacity Utilization (target: 70-80% â above 85% means no room to grow)'
    },
    {
  ...
  'Conversion': [
    {
      ...
      steps: [
        'Map every step from first contact to signed deal â identify where prospects stall',
        ...
        'Implement a follow-up cadence â no lead goes more than 48 hours without contact'
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        'Fix conversion before adding volume â otherwise you scale waste',
  ...
  'Lead Volume': [
    {
      ...
      steps: [
        ...
        'Measure cost per qualified lead weekly â scale only if CPA stays flat or drops'
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        'Run the sprint â no changes mid-sprint, just collect data',
